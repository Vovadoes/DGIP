...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(1000, 370))
        MainWindow.setMaximumSize(QtCore.QSize(1000, 370))
        ...
        self.label_6.setMinimumSize(QtCore.QSize(600, 35))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        ...
        self.doubleSpinBox.setMinimum(101.0)
        ...
        self.label.setMinimumSize(QtCore.QSize(600, 35))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "<html><head/><body><p>Введите вероятность того, что зерно заражено вредителями:</p></body></html>"))
        ...
        self.label.setText(_translate("MainWindow", "<html><head/><body><p>Введите число проверенных зерен:</p></body></html>"))
