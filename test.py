...
f1(s)
#
lst = '''self.n = mywindow.is_int(self.main_window.ui.doubleSpinBox)
        self.p = mywindow.is_float(self.main_window.ui.doubleSpinBox_2)
        self.k1 = mywindow.is_int(self.main_window.ui.doubleSpinBox_5)
        self.k2 = mywindow.is_int(self.main_window.ui.doubleSpinBox_6)'''\
